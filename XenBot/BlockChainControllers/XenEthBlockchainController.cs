...
namespace XenBot
{
    public class XenEthBlockchainController : IXenBlockChainController
    {
        ...
        public XenEthBlockchainController(IBlockchainController blockchainController, string abi, string contractAddress)
        {
