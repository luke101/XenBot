...
{
    public class OKXChainBlockchainController : IBlockchainController
    {
        private readonly string _provider;
        private readonly Web3 _web3;

        public string ChainName { get => "OKXChain"; }
        public int ChainId { get => 66; }
        public string Provider { get; init; }

        public OKXChainBlockchainController(string provider)
        {
            _provider = provider;
