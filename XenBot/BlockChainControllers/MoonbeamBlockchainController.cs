...
{
    public class MoonbeamBlockchainController : IBlockchainController
    {
        private readonly string _provider;
        private readonly Web3 _web3;

        public string ChainName { get => "Moonbeam"; }
        public int ChainId { get => 1284; }
        public string Provider { get; init; }

        public MoonbeamBlockchainController(string provider)
        {
            _provider = provider;
