...
{
    public class AvalancheBlockchainController : IBlockchainController
    {
        private readonly string _provider;
        private readonly Web3 _web3;

        public string ChainName { get => "Avalanche"; }
        public int ChainId { get => 43114; }
        public string Provider { get; init; }

        public AvalancheBlockchainController(string provider)
        {
            _provider = provider;
