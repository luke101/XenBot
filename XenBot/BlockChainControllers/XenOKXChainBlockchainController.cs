...
namespace XenBot
{
    public class XenOKXChainBlockchainController : IXenBlockChainController
    {
        ...
        public XenOKXChainBlockchainController(IBlockchainController blockchainController, string abi, string contractAddress)
        {
