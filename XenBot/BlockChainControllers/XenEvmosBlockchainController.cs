...
namespace XenBot
{
    public class XenEvmosBlockchainController : IXenBlockChainController
    {
        ...
        public XenEvmosBlockchainController(IBlockchainController blockchainController, string abi, string contractAddress)
        {
