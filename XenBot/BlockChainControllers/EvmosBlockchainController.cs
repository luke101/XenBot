...
{
    public class EvmosBlockchainController : IBlockchainController
    {
        private readonly string _provider;
        private readonly Web3 _web3;

        public string ChainName { get => "Evmos"; }
        public int ChainId { get => 9001; }
        public string Provider { get; init; }

        public EvmosBlockchainController(string provider)
        {
            _provider = provider;
